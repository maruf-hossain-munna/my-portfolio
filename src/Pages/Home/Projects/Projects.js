                    ...
                    <div className=' w-full h-full flex justify-center items-center backdrop-brightness-75'>
                        <div>
                            ...
                            <div className='flex gap-6 justify-center mt-3'>
                                <a href="https://github.com/maruf-hossain-munna/bikroy-bazar-client" target='_blank'>
                ...
                <div class=" portfolio-box potfolio-box-2 rounded-2xl">
                    <div className='w-full h-full flex justify-center items-center backdrop-brightness-75'>
                        <div>
                            ...
                            <div className='flex gap-6 justify-center mt-3'>
                                <a href="https://github.com/maruf-hossain-munna/learn-confidently" target='_blank'>
                                    <img className='h-10 w-10 rounded-full' src={github} alt="" />
                                </a>
                                <a href="https://learn-confidently.netlify.app/" target='_blank'>
                                    <img className='h-10 w-10 rounded-full' src={liveLink} alt="" />
                                </a>
                            </div>
                        </div>
